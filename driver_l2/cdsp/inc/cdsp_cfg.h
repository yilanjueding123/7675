 ...
 **************************************************************************/			
	...
	#define	TARGET_Y  				0x2a		//Luminace
	#define TARGET_Y_LOW			(TARGET_Y >> 2)	//TARGET_Y_LOW = TARGET_Y/4  
	#define MAX_ANALOG_GAIN			4		//3 ~ 5  	
	#define TARGET_Y_NIGHT			0x10
...
**************************************************************************/	
	...
	// DAYLIGHT_SAT_V_SCALE: Red,  upper 0x20: deep red,  less 0x20: light red
	//=========================================================================               	
	#define	DAYLIGHT_SAT_U_SCALE  	0x2b	//Default:0x20 	// blud
	#define	DAYLIGHT_SAT_V_SCALE  	0x2b	//Default:0x20	// red
...
**************************************************************************/	
	...
	// DAYLIGHT_SAT_V_SCALE: Red,  upper 0x20: deep red,  less 0x20: light red
	//=========================================================================               	
	#define	DAYLIGHT_SAT_U_SCALE  	0x2F	//Default:0x20 	// blud
	#define	DAYLIGHT_SAT_V_SCALE  	0x2F	//Default:0x20	// red
...
**************************************************************************/		
	...
	#define	TARGET_Y  				0x32//0x44	//Luminace
	#define TARGET_Y_LOW			(TARGET_Y/2)//TARGET_Y/4	//TARGET_Y_LOW = TARGET_Y/4  
	#define MAX_ANALOG_GAIN			 8		//3 ~ 5
	#define TARGET_Y_NIGHT			0x20							
		/**************************************************************************
		*	GC1004 Daylight Mode																														*
		**************************************************************************/ 
			...
			// DAYLIGHT_HUE_V_OFFSET:	+: more red,	-: more blue/green
							//=========================================================================
	#define	DAYLIGHT_HUE_U_OFFSET 	0//-1  //	-1		//-128 ~ +127,   +: more blue,  -: more yellow/green	
	#define	DAYLIGHT_HUE_V_OFFSET   0// -1//0 //	0 		//-128 ~ +127,   +: more red,  -: more blue/green
		...
		//		Y_SCALE = 0x22, Y_OFFSET range = 0~-15,  
		//=========================================================================
	#define	DAYLIGHT_HUE_Y_OFFSET  	0//-4	//-128 ~ +127	
	#define	DAYLIGHT_SAT_Y_SCALE  	0x24//0x26	//Default:0x20
		...
		// DAYLIGHT_SAT_V_SCALE: Red,  upper 0x20: deep red,  less 0x20: light red
		//========================================================================= 
	#define	DAYLIGHT_SAT_U_SCALE  	0x34	//Default:0x20 	// blud
	#define	DAYLIGHT_SAT_V_SCALE  	0x34	//Default:0x20	// red
	...
	#define DAYLIGHT_EDGE			3
		...
		// Parameters : +: warm,   -: cold , +10~-10
		//=========================================================================
	#define DAYLIGHT_WB_OFFSET		0//-1//0
	#define AUTO_WB_OFFSET			0
		...
		**************************************************************************/ 
			...
			// DAYLIGHT_HUE_V_OFFSET:	+: more red,	-: more blue/green
			//========================================================================= 							
	#define	NIGHT_HUE_U_OFFSET  0//	-1		//-128 ~ +127,   +: more blue,  -: more yellow/green	
	#define	NIGHT_HUE_V_OFFSET  0//	0		//-128 ~ +127,   +: more red,  -: more blue/green
		...
		//		Y_SCALE = 0x22, Y_OFFSET range = 0~-15,  
		//=========================================================================
	#define	NIGHT_HUE_Y_OFFSET  	0//-4//0		//-128 ~ +127	
	#define	NIGHT_SAT_Y_SCALE  		0x22//0x22//0X20	//Default:0x20
		...
		// DAYLIGHT_SAT_V_SCALE: Red,  upper 0x20: deep red,  less 0x20: light red
		//========================================================================= 				
	#define	NIGHT_SAT_U_SCALE  		0x30	//Default:0x20	// blud
	#define	NIGHT_SAT_V_SCALE  		0x30	//Default:0x20	// red
		
		//=========================================================================
		// Purpose :  set the sharpness
		// Parameters : 0:soft, 1:smooth, 2:normal, 3:strong
		//========================================================================= 
	#define NIGHT_EDGE				2//0	
		
		//=========================================================================
		// Purpose :  set the white balance offset
		// Parameters : +: warm,   -: cold , +10~-10
		//=========================================================================
	#define NIGHT_WB_OFFSET			0//0
