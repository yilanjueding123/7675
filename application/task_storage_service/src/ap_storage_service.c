...
#define AVI_REC_MAX_BYTE_SIZE	0x5dc00000//1500M//0x77500000// 0x1f400000//500mb//0x77500000// 0x70000000	//1879048192 Bytes//78643200//4B00000//0x77500000//1909mb
...
void ap_storage_service_file_open_handle(INT32U req_type)
{
	...
	switch (req_type)
	{
		...
		case MSG_STORAGE_SERVICE_AUD_REQ:
			...
			{
				__msg("MSG_STORAGE_SERVICE_AUD_REQ\n");
			}
